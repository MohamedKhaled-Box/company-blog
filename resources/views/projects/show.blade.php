    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-6">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div>
                    <h1
                        class="my-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white grid place-content-evenly">
                        {{ $project->title }}</h1>
                    @if ($project->picture)
                        <div class="grid place-content-evenly px-6">
                ...
                <div class="my-8 grid place-content-evenly px-6">
