...
return [
    ...
    */
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute على أحرف وأرقام أسكي ورموز فقط.',
    ...
    'extensions' => 'يجب أن يكون حقل :attribute لديه إحدى الامتدادات التالية: :values.',
    ...
    'not_regex' => 'يجب أن يكون حقل :attribute بتنسيق صحيح.',
    ...
    'password' => [
        ...
        'uncompromised' => 'لقد ظهر :attribute المُعطى في تسريب بيانات. الرجاء اختيار :attribute مختلفًا.',
    ],
    ...
    'prohibited' => 'يمنع حقل :attribute.',
    'prohibited_if' => 'يمنع حقل :attribute عندما يكون :other هو :value.',
    'prohibited_unless' => 'يمنع حقل :attribute ما لم يكن :other في :values.',
    'prohibits' => 'يمنع حقل :attribute من وجود :other.',
    'regex' => 'يجب أن يكون حقل :attribute بتنسيق صحيح.',
